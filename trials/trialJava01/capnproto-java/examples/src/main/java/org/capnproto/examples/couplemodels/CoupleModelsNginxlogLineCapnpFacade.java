...
public final class CoupleModelsNginxlogLineCapnpFacade {
    /*
    host @0 :Text;
    clientIP @1 :Text;
    timestamp @2 :Text;
    ...
    public CoupleModelsNginxlogLineCapnpFacade(CoupleModelsCapnp.NginxLogLine.Reader theNginxLogLineCapnpReader) {
